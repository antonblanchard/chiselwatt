...
object Control {
  ...
  val map = Array(
    ...
    LBZCIX        -> List(U_LDST, LDST_LOAD,  RA_RA_OR_ZERO, RB_RB,          DC,    ROUT_RT,   DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     N,     DC,      DC,       DC,        DC,       DC,        LEN_1B, N,          N,     N,          DC,  DC,      DC,        DC,         DC),
    LDCIX         -> List(U_LDST, LDST_LOAD,  RA_RA_OR_ZERO, RB_RB,          DC,    ROUT_RT,   DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     N,     DC,      DC,       DC,        DC,       DC,        LEN_8B, N,          N,     N,          DC,  DC,      DC,        DC,         DC),
    LHZCIX        -> List(U_LDST, LDST_LOAD,  RA_RA_OR_ZERO, RB_RB,          DC,    ROUT_RT,   DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     N,     DC,      DC,       DC,        DC,       DC,        LEN_2B, N,          N,     N,          DC,  DC,      DC,        DC,         DC),
    LWZCIX        -> List(U_LDST, LDST_LOAD,  RA_RA_OR_ZERO, RB_RB,          DC,    ROUT_RT,   DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     N,     DC,      DC,       DC,        DC,       DC,        LEN_4B, N,          N,     N,          DC,  DC,      DC,        DC,         DC),
    STBCIX        -> List(U_LDST, LDST_STORE, RA_RA_OR_ZERO, RB_RB,          RS_RS, ROUT_NONE, DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     N,     DC,      DC,       DC,        DC,       DC,        LEN_1B, N,          N,     N,          DC,  DC,      DC,        DC,         DC),
    STDCIX        -> List(U_LDST, LDST_STORE, RA_RA_OR_ZERO, RB_RB,          RS_RS, ROUT_NONE, DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     N,     DC,      DC,       DC,        DC,       DC,        LEN_8B, N,          N,     N,          DC,  DC,      DC,        DC,         DC),
    STHCIX        -> List(U_LDST, LDST_STORE, RA_RA_OR_ZERO, RB_RB,          RS_RS, ROUT_NONE, DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     N,     DC,      DC,       DC,        DC,       DC,        LEN_2B, N,          N,     N,          DC,  DC,      DC,        DC,         DC),
    STWCIX        -> List(U_LDST, LDST_STORE, RA_RA_OR_ZERO, RB_RB,          RS_RS, ROUT_NONE, DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     N,     DC,      DC,       DC,        DC,       DC,        LEN_4B, N,          N,     N,          DC,  DC,      DC,        DC,         DC),
    ...
    MCRF          -> List(U_CR,   CR_MCRF,    DC,            DC,             DC,    ROUT_NONE, DC,     DC,      DC,  DC,   CMP_RC_0,  DC,     DC,    DC,      DC,       DC,        DC,       DC,        DC,     DC,         DC,    DC,         DC,  DC,      DC,        DC,         DC),
